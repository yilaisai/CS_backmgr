...
export default {
  ...
  methods: {
    async fetchData () {
      let { result } = await this.$http.post('/wallet/backmgr/financial/coin/listCoinDetail', this.listQuery)
    ...
    async deleteDetail (row) {
      ...
      try {
        ...
        let result = await this.$http.delete('/wallet/backmgr/financial/coin/deleteCoinDetailById', params)
