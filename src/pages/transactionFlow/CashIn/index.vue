        ...
        <el-container>
			<div class="main">
				...
				<el-table :data="listData.list" border height="100%" size="mini" @selection-change="handleSelectionChange">
						...
						<el-table-column prop="taker_amount" label="数量" align="center">
							<template slot-scope="scope">
								{{Math.floor(scope.row.taker_amount*10000 + scope.row.fee*10000)/10000}}
							</template>
						</el-table-column>
						...
						<el-table-column prop="price" label="操作" fixed="right" align="center" width="300">
							<template slot-scope="scope">
								...
								<el-button type="danger" size="mini" v-if="(scope.row.trade_status==8||scope.row.trade_status==4||scope.row.trade_status==7)&&showActiveBtn(scope.row.create_time)" @click.native="orderActivation(scope.row)">激活订单</el-button>
