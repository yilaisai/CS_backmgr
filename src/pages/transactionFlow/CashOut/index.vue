			...
			<el-container>
				<div class="main">
					...
					<el-table :data="listData.list" border height="100%" size="mini">
							...
							<el-table-column label="商户编号/账户" width="150" align="center">
							...
							<el-table-column prop="price" label="操作" fixed="right" align="center" width="300">
								<template slot-scope="scope">
									...
									<el-button type="danger" size="mini" v-if="scope.row.trade_status==2" @click.native="activationLetgo(scope.row.trade_id)">&nbsp;&nbsp;放 &nbsp;&nbsp;行&nbsp;&nbsp;</el-button>
