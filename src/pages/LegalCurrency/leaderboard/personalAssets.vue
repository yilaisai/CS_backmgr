		...
		<div class="main">
			<div class="title">
				...
				<el-table stripe border   :data="customerInfo" >
					...
					<el-table-column prop="totalToUsdt"  label="资产总折合（CNY）"></el-table-column>
			...
			<div class="tableBox">
				<div>
					...
					<el-table stripe border   :data="walletList" >
						...
						<el-table-column prop="amount" label="可用（CNY）"></el-table-column>
						<el-table-column prop="frozenAmount"  label="冻结（CNY）"></el-table-column>
