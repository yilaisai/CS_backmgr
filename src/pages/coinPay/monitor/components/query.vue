		...
		<el-collapse-item title="查询条件" name="filter">
			<el-form ref="form" :model="formData" label-width="100px" size="mini" inline>
				<div>
					...
					<el-form-item label="币支付订单号：">
						<el-input v-model="formData.txId" placeholder="币支付订单号"></el-input>
					</el-form-item>
				</div>
				<div>
					...
					<el-form-item label="订单匹配状态：">
						<el-select v-model="formData.collectType" placeholder="选择订单匹配状态" clearable style="width: 178px">
							<el-option :value="null" label="全部"></el-option>
